    ...
    <div className="terms-and-conditions">
      <div className="container">
        ...
        <section>
          ...
          <p>B2B Lead Solutions ("we","our") operates the "Service," which is defined as any website or web page on which this set of Terms appears ("Website"), and any data, services, activity or transactions that are offered, made available or facilitated through any of the above.</p>
        ...
        <section>
          ...
          <ul>
            ...
            <li>The foregoing license grants to B2B Lead Solutions shall be non-exclusive, perpetual and royalty-free. B2B Lead Solutions shall have the right to sublicense, assign, or transfer such licenses in its discretion.</li>
          </ul>
        ...
        <section>
          ...
          <p>As between you and B2B Lead Solutions, all rights, title and interest in and to the Service, including without limitation patents, copyrights, trademarks, trade names, service marks, trade secrets and other intellectual property rights, and any goodwill associated with the Service, are owned by B2B Lead Solutions. For instance, we own any design or product features inherent in the Service, such as the way that data is organized, curated, presented and delivered, and any know-how or other intellectual property inherent in the way we have create, provide, display or make available the Service. The B2B Lead Solutions names and logos are trademarks of B2B Lead Solutions, and may not be copied, imitated or used, in whole or in part, without our prior written permission.</p>
        ...
        <section>
          ...
          <ol className="lettered-list">
            ...
            <li>use B2B Lead Solutions's service in conjunction with any unsolicited or harassing messages (commercial or otherwise) including but not limited to unsolicited emails, or phone calls</li>
          </ol>
          <p>If you know or suspect anyone violating these policies, please notify us at abuse@b2bleadsolutions.io. B2B Lead Solutions will determine compliance of this policy at its sole discretion.</p>
        </section>
        ...
        <section>
          ...
          <p>To the extent that B2B Lead Solutions processes any Customer Personal Data (as defined in the B2B Lead Solutions Data Processing Agreement) that is subject to the European General Data Protection Regulation (GDPR) or other applicable European data protection rules, on Customer's behalf, in the provision of the services hereunder, the terms of the B2B Lead Solutions Data Processing Agreement, which are hereby incorporated by reference, shall apply. For customers that are located in the European Union, the United Kingdom, Switzerland, or the European Economic Area, the Standard Contractual Clauses adopted by the European Commission, attached to the Data Processing Agreement, with B2B Lead Solutions, which provide adequate safeguards with respect to the personal data processed by us under this Agreement and pursuant to the provisions of our Data Processing Agreement apply.</p>
        ...
        <section>
          ...
          <ul>
            ...
            <li>B2B Lead Solutions runs a vulnerability discovery program. If you suspect there are any vulnerability with our services, please reach out to support@b2bleadsolutions.io and we will look into those for you.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>Legal notices (including but not limited to termination notices) must be sent to support@b2bleadsolutions.io or Cyber Hub, Level 1, Tower A, Bldg. # 10, Cyber City, Phase II. Gurgaon-122002. Haryana. We will send legal notices to You via a method of our choosing that is reasonably intended to provide such notice to You, including without limitation via the Service or to the email or other address You have provided to us.</p>
