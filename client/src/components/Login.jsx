...
function Login({ closeModal, setShowModal, setSShowModal }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("http://13.203.218.236:3005/users/login", {
        method: "POST",
        headers: {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      const response = await fetch("http://13.203.218.236:3005/users/send-otp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://13.203.218.236:3005/users/reset-password", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
