  ...
  useEffect(() => {
    const fetchUserStatistics = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `http://3.109.203.132:8000/bulkUpload/userStatistics?email=${userEmail}&fromDate=${formattedDate}`
        );
    ...
    const fetchFileHistory = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `http://3.109.203.132:8000/excel/history/${userEmail}?fromDate=${formattedDate}`
        );
