...
//   try {
//     const response = await axios.get('http://localhost:8000http://localhost:8000/credit-cost', {
//       params: { email } // This will create http://localhost:8000/credit-cost?email=user@example.com
//     });
